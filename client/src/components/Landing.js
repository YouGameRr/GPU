...
export default function Home() {
    ...
    return (
        <div>
            <div className="flex-col md:flex-row flex justify-around mt-8 sm:mt-16 font-['Chelsea_Market']">

                <div className="sm:hidden flex justify-center">
                    <img alt="" className="rounded-[25px] w-[90%]" src="https://www.safetydetectives.com/wp-content/uploads/2018/12/Parents-Guide-for-Safe-YouTube-and-Internet-Streaming-for-Kids.png"/>
                </div>
                ...
                <div className="text-white ml-8 mt-8">
                    ...
                    <p className="text-3xl sm:text-6xl font-bold">For Underaged</p>
                    <p className="text-xl sm:text-3xl mt-6">A Password Scheme for Underaged</p>
                    <p className="text-xl sm:text-3xl">With a User Experience Of </p>
                    <p className="text-xl sm:text-3xl">Graphical Password Authentication.</p>
                    <button onClick={handleKnowMore} class="px-5 py-5 flex-col md:flex-row flex justify-around mt-8 sm:mt-16 font-['Chelsea_Market']">
                        ...
                        <div class="relative group">
                         <div class="absolute -inset-0.5 bg-gradient-to-r from-pink-600 to-purple-600 rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
                            <button class="relative px-7 py-4 bg-black rounded-lg leading-none flex items-center divide-x divide-gray-600">
                             ...
                             <FontAwesomeIcon className="text-white mr-3" icon={faFingerprint} />
                             <span class="pr-6 text-gray-100">Know More</span>
                            </span>
                            </button>
                        </div>
                        </div>
                ...
                <div className="hidden sm:block">
                    <img alt="" className=" hover:scale-95 transition duration-500 ease-in-out hover:shadow-2xl hover:shadow-[#A259FF80] rounded-[25px] w-full" src="https://www.safetydetectives.com/wp-content/uploads/2018/12/Parents-Guide-for-Safe-YouTube-and-Internet-Streaming-for-Kids.png"/>
                </div>
            </div>

            <div id="home--2" className="sm:mt-48 font-['Chelsea_Market']">
