    ...
    return (
        <div className="md:p-6 py-2 px-4 flex justify-between">
            ...
            <div className="flex items-center cursor-pointer" onClick={() => window.location.reload()}>
                ...
                <p className="md:text-xl text-white ml-2 font-['Chelsea_Market'] font-bold">Graphical Password for Underaged</p>
            </div>

            {/*nav element list*/}
            <div className="font-['Chelsea_Market'] text-white hidden md:flex items-center">
                ...
                {props.loggedIn && <div className="flex">
                    <p className={`text-2xl font-Chelsea_Market text-[#A259FF]`}>{props.userInfo.username}</p>
