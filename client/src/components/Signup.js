    ...
    return (
        <div className=" sm:h-[38rem] mt-12">
            {!next && <div className="flex justify-center h-full">
                ...
                {/*SIGNUP FORM*/}
                <div className="font-['Chelsea_Market'] mt-4">
                    ...
                    <p className="text-white text-lg sm:text-2xl px-4 sm:px-0">Graphical Password for Underaged.</p><br/>
                    ...
                    <button onClick={handleNextClick} class="px-7 py--100 flex-col md:flex-row flex justify-around mt-10 sm:mt-5 font-bold">
                     <div class="items-start justify-center">
                        <div class="relative group">
                         <div class="absolute -inset-0.5 bg-gradient-to-r from-pink-600 to-purple-600 rounded-full blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt rounded-full px-7"></div>
            ...
            {next && <div className="sm:flex h-full">
                ...
                {/*DESKTOP VIEW*/}
                <div className="hidden sm:block font-['Chelsea_Market'] mt-4 ml-12">
                ...
                {/*MOBILE VIEW*/}
                <div className="sm:hidden font-['Chelsea_Market'] mt-4 ml-4">
