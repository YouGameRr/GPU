...
export default function Digest() {
    ...
    return (
        <div className="flex sm:flex-row flex-col justify-center bg-[#3B3B3B] rounded-[25px] mt-12 sm:mt-24 w-[90%] sm:w-3/4 mx-auto">
            <div className="flex justify-center rounded-[20px] transition duration-500 ease-in-out hover:scale-95 px-4 sm:w-2/5 sm:ml-12 my-4 sm:my-16">
                <img alt="" src="https://www.alivewithideas.com/wp-content/uploads/2023/05/Best-Newsletter-Blog_BANNER-1360x464.png"/>
            </div>

            <div className="px-4 sm:px-0 font-['Chelsea_Market'] text-white max-w-lg mx-auto sm:mt-16">
                <p className="text-3xl sm:text-5xl font-bold">Subscribe To Our Monthly Newsletters.</p>
                <p className="text-lg sm:text-2xl mt-4">Get Latest Promotions & Updates Staight To Your Inox</p>
